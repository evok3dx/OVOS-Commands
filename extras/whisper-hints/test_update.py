...
class HintTests(unittest.TestCase):
    ...
    def test_old_prompt_replaced_custom_prompt_preserved(self):
        self.assertEqual(hints.build_prompt(['Jarvis','Mega'],hints.ORIGINAL)[0],'Jarvis, Mega.')
    ...
    def test_whole_names_byte_budget_unicode_and_name_cap(self):
        ...
        self.assertTrue(all(n in names for n in prompt[:-1].split(', ')))
...
class ProfileTests(unittest.TestCase):
    ...
    def test_complete_execute_uses_current_profile(self):
        ...
        self.assertEqual(engine.transcribe.call_args.kwargs['initial_prompt'],'Jarvis, mega, MEGAsync.')
